        ...
        $TEXT1, $TEXT2, $TEXT3, $TEXT4, $TEXT5, $TEXT6, $TEXT7, $TEXT8, $TEXT9, $TEXT10, $TEXT11, $TEXT12, $TEXT13)
    {
        ...
        if(_CheckGMAccess($AccountDBHost, $DBUser, $DBPassword, $AccountDB, $ID, $GMLevel)) {
            ...
            while($row = mysql_fetch_array($query)) {
			 ...
			 <td><a class="btn btn-success btn-sm" href="status.php?id='.$row["id"].'&GMl='.$GMLevel.'&rr='.$AccountDB.'&Real='.$row["oRealmlist"].'&rr1='.$Pass.'&encode='.$Pass1.'">Ver Estado 1</a><br>
			 <td><a class="btn btn-success btn-sm" href="status2.php">Ver Estado 2</a>';		
