<?php
    ...
    switch($language) {
        ...
        case "es": {
            ...
            $write[76] = 'Sube el dump "WoW_Legendary.lua"';
            $write[75] = 'Descarga el addon para hacer dump de tu PJ <b><a href = "WoW_Legendary.rar">WoW_Legendary.rar</a></b><br> Escribe /migrar en el chat. <br> Para guardar las cosas de fuera del banco debes tener la ventana abierta. <br> Para conservar las recetas de tus profesiones debes abrir las profesiones. <br> Desconecta del servidor y sube el dump, (se encuentra en WTF \ Account \ %Username% \ SavedVariables \ WoW_Legendary.lua) <br></ a>';
