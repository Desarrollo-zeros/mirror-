<?php
    ...
    $DBPassword         = "toor";       // Your DB Password

    $SOAPUser           = "migration";          // SOAP USER
    $SOAPPassword       = "4015594wae";          // SOAP USER PASSWORD
    $GMLevel            = "(5)";    // GM LEVEL ACCESS AVAIBLE CHECK TRANSFERS. IN BRACKETS AND SEPARATE WITH COMMA. EXAMPLE: "(3,4)"
